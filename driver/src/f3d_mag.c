...
void f3d_mag_init() {
  ...
  f3d_i2c1_write(0x3C, 0x00,  &value); // Mag (0x3C), CRA (0x00) //0001 0100

  value = 0xE0;                      // +/- 8.1 Gauss Full Scale
  f3d_i2c1_write(0x3C, 0x01, &value); // Mag (0x3C), CRB (0x01) //1110 0000

  value = 0x00;                      // Continuous Conversion
  f3d_i2c1_write(0x3C, 0x02, &value); // Mag (0x3C), MR  (0x23) //0000 0000
}
